...
import com.yudapramadjunaedi.githubuser.views.TitleBar;
...
public class CollapsingTopBar extends TopBar implements CollapsingView {
    ...
    private void createBackgroundImage() {
        if (params.hasBackgroundImage()) {
            ...
            AppBarLayout.LayoutParams lp = new AppBarLayout.LayoutParams(AppBarLayout.LayoutParams.MATCH_PARENT, (int) CollapsingTopBarBackground.MAX_HEIGHT);
    ...
    private void createReactHeader(CollapsingTopBarParams params) {
        if (params.hasReactView()) {
            ...
            titleBarAndContextualMenuContainer.addView(header, new AppBarLayout.LayoutParams(MATCH_PARENT, WRAP_CONTENT));
